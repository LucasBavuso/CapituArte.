        ...
        <div class="container mt-3">
            <div class="borda p-5 rounded">
                ...
                <form action="cadastrar.php" method="post">
                    <label for="Nome do usuario">Nome</label>
                    ...
                    <br>
                    <br>
                    <label for="Email do usuario">E-mail</label>
                    <input type="text" name="txtEmail" style="width: 100%; height: 40px; border-radius:5px"
                    ...
                    <br>
                    <br>
                    <label for="CPF do cliente"> CPF </label>
                    ...
                    <br>
                    <br>
                    <label for="Telefone do cliente">Telefone</label>
                    ...
                    <input type="text" name="txtComplemento" style="width: 30%; height: 40px; border-radius:5px"
                        required placeholder="Insira o complemento" id="complemento" />
                    <br>
                    <br>
