...
<body>
    ...
    <div class="container mt-3">
        ...
        <form action="carrinhomicro.php?acao=up" method="post">
            ...
            <a class="btn btn-info" href="princmicro.php">Continuar Comprando</a>
            <button class="btn btn-primary" type="submit">Atualizar Carrinho</button>
            <a class="btn btn-success" href="finalizarcarrinhomicro.php">Finalizar Pedido</a>
            <br><br>
