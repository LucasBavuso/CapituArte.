...
<div style="background-color: #1c110a; height: 120px; margin: 0;">
        ...
        <div style="background-color: #e9b44c;">
            <h3 style="text-align: center;color:#9B2915">MICROEMPREENDEDORES CADASTRADOS</h3>
        </div>
    <?php
    
        $sql = "SELECT * FROM tbmicroemp order by idMicro";
    ...
    ?>
        ...
        ?>
                <tr>
                    ...
                    <td><?php echo $exibir["chavepix"]?></td>
                    <td> <a href= "editarmicro.php?idMicro=<?php echo $exibir['idMicro'] ?>"> Editar</td>
                    <td> <a href= "#" onclick = "confirmarExclusao(
                            '<?php echo $exibir["idMicro"] ?> ',
         ...
         <script>
            function confirmarExclusao (idMicro, nomeCompleto){
                if (window.confirm("Deseja realmente excluir o registro: \n" + idMicro + nomeCompleto + " ?")){
                    window.location = "excluirmicro.php?idMicro=" + idMicro;
                }
            }
         </script>   
